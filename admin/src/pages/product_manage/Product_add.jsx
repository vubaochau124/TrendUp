    ...
    <form className='flex flex-col w-full items-start gap-3'>
      ...
      <div>
        ...
        <div className='flex gap-3'>
          <div onClick={() => setSizes(prev => prev.includes("S") ? prev.filteer(item => item !== "S") : [...prev, "S"])}>
            <p className={`${sizes.includes("S") ? "bg-blue-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>S</p>
          </div>

          <div onClick={() => setSizes(prev => prev.includes("M") ? prev.filteer(item => item !== "M") : [...prev, "M"])}>
            <p className={`${sizes.includes("M") ? "bg-blue-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>M</p>
          </div>

          <div onClick={() => setSizes(prev => prev.includes("L") ? prev.filteer(item => item !== "L") : [...prev, "L"])}>
            <p className={`${sizes.includes("L") ? "bg-blue-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>L</p>
          </div>

          <div onClick={() => setSizes(prev => prev.includes("XL") ? prev.filteer(item => item !== "XL") : [...prev, "XL"])}>
            <p className={`${sizes.includes("XL") ? "bg-blue-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>XL</p>
          </div>

          <div onClick={() => setSizes(prev => prev.includes("2XL") ? prev.filteer(item => item !== "2XL") : [...prev, "2XL"])}>
            <p className={`${sizes.includes("2XL") ? "bg-blue-100" : "bg-slate-200"} px-3 py-1 cursor-pointer`}>2XL</p>
          </div>
        </div>
      </div>
